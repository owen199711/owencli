...
T3 = TestCase(
    ...
    ground_truth="Alice+Bob+室友+创业+Charlie+AI+合作+Diana+辩论+约会+挖角+传闻+投资+澄清+股份+吵架+Eve+好友+社团+好感+三角",
)
...
T4 = TestCase(
    ...
    ground_truth="50+60+300+500+15+1200+0.1+200+150+4+CPU+内存+错误率+延迟+扩容+GC+490+6+清理+7+90+85+100",
    expected_json={
        "初始CPU": "50%",
        "初始内存": "60%",
        "初始磁盘配额": "500GB",
...
T5 = TestCase(
    ...
    ground_truth="A链:8:00告警→10:00排查→16:00扩容→周二02:00修复 B链:14:00攻击→18:00拦截→周二06:00遏制 交叉点:备份系统被攻击 非事件:版本发布取消 总时长:34小时",
)
...
T6 = TestCase(
    ...
    ground_truth="React+Go+PostgreSQL+Redis+RabbitMQ+Vue+Python+MySQL+Kafka+12月15日",
    expected_json={
        "Alpha前端": "React",
        "Alpha后端": "Go",
        "Alpha数据库": "PostgreSQL",
